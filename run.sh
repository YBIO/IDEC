...
DATASET=ade
TASK=100-50 # [100-5, 100-10, 100-50, 50-50]
EPOCH=50
BATCH=12
LOSS=bce_loss
KD_LOSS=KD_loss
...
python main.py --data_root ${DATA_ROOT} --model deeplabv3_resnet101 --gpu_id 0,1,2,3 \
...
#     --unknown --w_transfer --amp --mem_size ${MEMORY} --contrastive_learning
