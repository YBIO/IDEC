...
def main(opts):
    ...
    # Set up knowledge distillation loss for ret layers
    ...
    # Initialize class-weight
    # if opts.use_KD_class_weight:
    #     KD_class_weight = 
    ...
    while cur_itrs < total_itrs:
        ...
        with torch.cuda.amp.autocast(enabled=opts.amp):
            ...
            if model_prev is not None and opts.curr_step>0:
                ...
                if opts.use_KD_layer_weight:
                    KD_loss_ret_l1 = KD_layer_weight['l1'] * lamb * tot criterion_KD(ret_features['feature_l1'], ret_features_prev['feature_l1'])
